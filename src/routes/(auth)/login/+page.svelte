    ...
    <div class="grid xl:grid-cols-2 items-center">
        <div class="p-6 md:p-16 max-w-2xl mx-auto">
            ...
            <div class="grid md:grid-cols-2 gap-3 mb-6">
                <button type="button" class="border hover:bg-gray-100 px-5 py-2.5 rounded-lg flex justify-center items-center">
                    <svg class="mr-3" width="24px" height="24px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <Divider text="OR" />
            <form class="mt-8">
                <Input placeholder="name@company.com" label="Email" type="email" name="email" id="email" />
                <Input placeholder="&bullet;&bullet;&bullet;&bullet;&bullet;&bullet;&bullet;&bullet;" label="Password" type="password" name="password" id="password" />
                <div class="mb-3 flex items-center justify-between text-sm">
                    <div class="flex items-start">
                        <input class="accent-primary-700" type="checkbox" name="checkbox" id="checkbox">
                        <label for="checkbox" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Remember me</label>
                    </div>
                    <a href="/forgot-password">Forgot password?</a>
                </div>
                <Button type="button" classes="w-full mt-8 mb-5 font-medium" name="Create an account" />
                <p class="text-sm text-gray-600">Dont have an account? <a href="/register" class="font-medium">Sign Up</a></p>
            </form>
        </div>
        <div class="bg-primary-700 text-white xl:h-screen flex flex-col justify-center items-start p-6 md:p-16">
            <a href="/" class="text-2xl mb-3 font-bold text-white">{Settings.SITE_NAME}</a>
            <h2 class="text-3xl md:text-5xl font-bold mb-6">Explore the world's leading design portfolios.</h2>
            <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Incidunt recusandae voluptates asperiores consequatur, pariatur placeat obcaecati suscipit maxime illo illum? Lorem ipsum dolor sit, amet consectetur adipisicing elit. Aut, commodi?</p>
